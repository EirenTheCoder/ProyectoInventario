...
public class Proveedores extends javax.swing.JPanel {
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        if(dao.insertar(p)){
            JOptionPane.showMessageDialog(null, "El proveedor se ha registrado con éxito");
            limpiarCampos();
            limpiarTablaProveedor();
            listarProveedores();
        } else {
            JOptionPane.showMessageDialog(null, "No se pudo registrar al proveedor");
        }
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        if(fila==-1&&txtid.getText().isEmpty()){
            JOptionPane.showMessageDialog(null, "Seleccione un registro de proveedor");
        }else{
            ...
            p.setCorreo(txtcorreo.getText());
            if(dao.editar(p)){
               JOptionPane.showMessageDialog(null, "Se modifico el registro con éxito");
               limpiarCampos();
               limpiarTablaProveedor();
               listarProveedores();
            }else{
               JOptionPane.showMessageDialog(null, "Error al modificar el registro de proveedor");
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        if(!txtid.getText().isEmpty()){
            ...
            if(confirmar==0){
                ...
                limpiarTablaProveedor();
                listarProveedores();
                JOptionPane.showMessageDialog(null, "Se elimino el registro de proveedor con éxito");
            }
        }else{
            JOptionPane.showMessageDialog(null, "Seleccione un registro de proveedor");
        }
