...
public class BuscarEntrada extends javax.swing.JFrame {
    ...
    private void tblEntradasMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblEntradasMouseClicked
        ...
        txtid.setText(tblEntradas.getValueAt(fila, 0).toString());
        txtnombre.setText(tblEntradas.getValueAt(fila, 1).toString());
        txtstock.setText(tblEntradas.getValueAt(fila, 2).toString());
        txtprecio.setText(tblEntradas.getValueAt(fila, 3).toString());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarEntrada.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
